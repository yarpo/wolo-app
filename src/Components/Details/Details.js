    ...
    <div id="details">
      <div id="container_details">
        <div id="column">
          ...
          <ul id="information">
            <li>
              <VscBrowser /> <strong>{t('date')}:</strong>{' '}
            </li>
            <li>
              <BiTime /> <strong>{t('time')}:</strong>{' '}
            </li>
            <li>
              <BiBorderAll /> <strong>{t('category')}:</strong>{' '}
            </li>
            <li>
              <VscOrganization /> <strong>{t('organizer')}:</strong>{' '}
            </li>
          </ul>
        </div>
        ...
        <div id="column" className="location">
          <p id="location">
            <VscLocation /> <strong>{t('location')}:</strong>{' '}
          </p>
          <div>
            <iframe
