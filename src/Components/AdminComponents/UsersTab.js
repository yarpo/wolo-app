...
const UsersTab = () => {
	...
	return (
		<div className="overflow-x-auto">
			...
			{openModal && (
				<AddUser onAccept={handleModalAccept} onClose={handleModalClose} />
			)}
			<Table striped>
				<Table.Head>
									...
									<Table.Cell colSpan="8">
										<div className="dropdown-content">
											...
											<p>
												...
												{user.agreementSigned ? "YES" : "NO"}
											</p>
											<p>
												<strong>PESEL Verified: </strong>
												{user.peselVerified ? "YES" : "NO"}
											</p>
										</div>
									</Table.Cell>
								</Table.Row>
