...
function EditCategory({ onAccept, onClose, userData }) {
    ...
    const [agreementSigned, setAgreementSigned] = useState(userData.agreementSigned);
    ...
    const handleAgree = () => {
        ...
        onAccept({firstName, lastName, email, phoneNumber, peselVerified, agreementSigned, adult});
        setOpenModal(false);
    };
        ...
        <Modal show={openModal} size="md" popup onClose={handleClose} initialFocus='firstname'>
            ...
            <div className="space-y-6">
                ...
                <div className="max-w-md">
                    ...
                    <TextInput id="phone" value={phoneNumber} onChange={e => setPhoneNumber(e.target.value)} icon={HiPhone} />
                </div>
