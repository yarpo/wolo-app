        ...
        <div className="details_container">
            <div id="column">
                ...
                <ul id="information">
                    ...
                    <li><VscOrganization id="icon" /> <strong>{t('organizer')}:</strong> <Link to={`/organisation?organisationId=${eventData.organisationId}`} className='details-organisaton'>{organisationName}</Link></li>
            ...
            <div id='column'>
                ...
                <div className='details_shift_card_wrapper'>
                    {eventData.shifts.sort((a, b) => new Date(a.shiftId) - new Date(b.shiftId)).map((shift, index) => (
                        <ShiftCard key={shift.id || index} shift={shift} city={city} isInPast={isInPast} />
                    ))}
                </div>
